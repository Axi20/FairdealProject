            ...
            <Col>
              <div className='internal-div'>
                <p className='hidden'>{car1.id}</p>
                  ...
                  <h2 className='car-brand' id="brand">{car1.brand}</h2>
                  <p className='car-price' id="price">{car1.price} Ft/nap</p>
                  <div className='data-div'>
                      <p className='car-data' id="engine_size">{car1.engine_size} cm<sup>3</sup></p>
                      <p className='car-data' id="consumption">{car1.consumption} l/100km</p>
                      <p className='car-data' id="fuel">{car1.fuel}</p>
